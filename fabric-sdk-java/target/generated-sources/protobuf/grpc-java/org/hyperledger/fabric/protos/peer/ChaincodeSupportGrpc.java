...
public final class ChaincodeSupportGrpc {
  ...
  public static ChaincodeSupportStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ChaincodeSupportStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ChaincodeSupportStub>() {
        @java.lang.Override
        public ChaincodeSupportStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new ChaincodeSupportStub(channel, callOptions);
        }
      };
    return ChaincodeSupportStub.newStub(factory, channel);
  }
  ...
  public static ChaincodeSupportBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ChaincodeSupportBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ChaincodeSupportBlockingStub>() {
        @java.lang.Override
        public ChaincodeSupportBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new ChaincodeSupportBlockingStub(channel, callOptions);
        }
      };
    return ChaincodeSupportBlockingStub.newStub(factory, channel);
  }
  ...
  public static ChaincodeSupportFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ChaincodeSupportFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ChaincodeSupportFutureStub>() {
        @java.lang.Override
        public ChaincodeSupportFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new ChaincodeSupportFutureStub(channel, callOptions);
        }
      };
    return ChaincodeSupportFutureStub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class ChaincodeSupportStub extends io.grpc.stub.AbstractAsyncStub<ChaincodeSupportStub> {
    private ChaincodeSupportStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ChaincodeSupportStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ChaincodeSupportStub(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class ChaincodeSupportBlockingStub extends io.grpc.stub.AbstractBlockingStub<ChaincodeSupportBlockingStub> {
    private ChaincodeSupportBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ChaincodeSupportBlockingStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ChaincodeSupportBlockingStub(channel, callOptions);
    }
  }
   ...
   * </pre>
   */
  public static final class ChaincodeSupportFutureStub extends io.grpc.stub.AbstractFutureStub<ChaincodeSupportFutureStub> {
    private ChaincodeSupportFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ChaincodeSupportFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ChaincodeSupportFutureStub(channel, callOptions);
    }
  }
