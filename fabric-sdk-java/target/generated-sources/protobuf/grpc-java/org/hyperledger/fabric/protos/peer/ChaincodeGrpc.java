...
public final class ChaincodeGrpc {
  ...
  public static ChaincodeStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ChaincodeStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ChaincodeStub>() {
        @java.lang.Override
        public ChaincodeStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new ChaincodeStub(channel, callOptions);
        }
      };
    return ChaincodeStub.newStub(factory, channel);
  }
  ...
  public static ChaincodeBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ChaincodeBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ChaincodeBlockingStub>() {
        @java.lang.Override
        public ChaincodeBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new ChaincodeBlockingStub(channel, callOptions);
        }
      };
    return ChaincodeBlockingStub.newStub(factory, channel);
  }
  ...
  public static ChaincodeFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ChaincodeFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ChaincodeFutureStub>() {
        @java.lang.Override
        public ChaincodeFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class ChaincodeStub extends io.grpc.stub.AbstractAsyncStub<ChaincodeStub> {
   ...
   * </pre>
   */
  public static final class ChaincodeBlockingStub extends io.grpc.stub.AbstractBlockingStub<ChaincodeBlockingStub> {
    private ChaincodeBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ChaincodeBlockingStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ChaincodeBlockingStub(channel, callOptions);
    }
  }
   ...
   * </pre>
   */
  public static final class ChaincodeFutureStub extends io.grpc.stub.AbstractFutureStub<ChaincodeFutureStub> {
    private ChaincodeFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ChaincodeFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ChaincodeFutureStub(channel, callOptions);
    }
  }
